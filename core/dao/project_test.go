...
func TestProject_GetProjectsByPath(t *testing.T) {
	config := Config{
		Dir: "/base",
		ProjectList: []Project{
			{Name: "project1", Path: "/base/trinhminhtriet/app1", RelPath: "trinhminhtriet/app1"},
			{Name: "project2", Path: "/base/backend/api", RelPath: "backend/api"},
			{Name: "project3", Path: "/base/trinhminhtriet/app2", RelPath: "trinhminhtriet/app2"},
		},
	}
	...
	tests := []struct {
		...
		},
		{
			...
			paths:         []string{"trinhminhtriet/app1"},
			expectError:   false,
			expectedNames: []string{"project1"},
		},
		{
...
func TestProject_TestAddToTree(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			name: "simple tree",
			nodes: []TNode{
				{Name: "app1", Path: "trinhminhtriet/app1"},
				{Name: "app2", Path: "trinhminhtriet/app2"},
		...
		},
		{
			name: "nested tree",
			nodes: []TNode{
				{Name: "app1", Path: "trinhminhtriet/web/app1"},
				{Name: "app2", Path: "trinhminhtriet/mobile/app2"},
			},
